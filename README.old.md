Initial clean project is bootstraped from [Create React App](https://github.com/facebook/create-react-app), and slightly modified to use typescript instead of javascript.
